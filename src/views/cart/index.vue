            ...
            <tr v-for="item in $store.getters['cart/validList']" :key="item.skuId">
              ...
              <td class="tc">
                ...
                <p v-if="item.price-item.nowPrice>0" >
                  比加入时降价 <span class="red">&yen;{{ item.price-item.nowPrice}}</span></p>
              </td>
              <td class="tc">
              ...
              <td class="tc">
                ...
                <p><a class="green" href="javascript:;" @click="deleteCart" >删除</a></p>
...
export default {
  ...
  setup () {
    ...
    const batchDeleteCart = (isClear) => {
      Confirm({ text: `您确认从购物车删除${isClear ? '失效' : '选中'}的商品吗？` }).then(() => {
